$(function () {
    ...
    form.append("chart", "CassFreight");
    form.append("frequency", "1month");

    var settings = {
        "url": urlresource + "/transport_chart_data/",
        "method": "POST",
        "timeout": 0,
        "dataType": 'JSON',
        "processData": false,
    ...
    $.ajax(settings).done(function (response) {
        ...
        var data = response
        // console.log(data);
        Highcharts.chart('container_CassFreight_2', {
            chart: {
              // spacingTop: 0,
              // width: 375,
              height: 280,
        ...
        xAxis: {
          crosshair: {
            ...
            series: [{
              type: 'area',
              name: 'Employees in Thousands of Persons',
              data: data,
              color: '#9bb556',
              // lineColor: '#70843A',
              lineWidth: 2.5
            ...
            lang: {
              noData: "Data published on a monthly basis.<br> Please refer to the tabs having data<br> for 3 months or more to see the trends."
            },
          });
