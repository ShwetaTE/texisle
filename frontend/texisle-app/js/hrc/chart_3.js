$(function () {
  ...
  futureDate3 = future_date_range(3 * 30);

  var form = new FormData();
  form.append("chart", "HRC");
  form.append("frequency", "3month");
        ...
        breaks: [
          {
            ...
            to: data[1][data[1].length - 1][0] + 35 * 24 * 3600 * 1000, //days*hours*seconds*milliseconds
            breakSize: 0,
          },
        ],
        // type: 'datetime',
