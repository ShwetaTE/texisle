$(function () {
  ...
  futureDate4 = future_date_range(6 * 30);

  var form = new FormData();
  form.append("chart", "HRC");
  form.append("frequency", "6month");
        ...
        breaks: [
          {
            ...
            to: data[1][data[1].length - 1][0] + 70 * 24 * 3600 * 1000, //days*hours*seconds*milliseconds
            breakSize: 0,
          },
        ],
      },
