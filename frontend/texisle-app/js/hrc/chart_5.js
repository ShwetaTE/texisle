$(function () {
  ...
  futureDate5 = future_date_range(365);

  var form = new FormData();
  form.append("chart", "HRC");
  form.append("frequency", "1year");

  var settings = {
    url: urlresource + "/rmi_chart_data/",
    method: "POST",
    timeout: 0,
    dataType: "JSON",
    processData: false,
  ...
  $.ajax(settings).done(function (response) {
    ...
    var data = response;
    console.log("HRC 1 YEAR", data[1][data[1].length - 1]);
    Highcharts.chart("container2_6", {
      chart: {
        // spacingTop: 0,
        // width: 375,
        height: 280,
        ...
        breaks: [
          {
            ...
            to: data[1][data[1].length - 1][0] + 60 * 24 * 3600 * 1000, //days*hours*seconds*milliseconds
            breakSize: 0,
          },
        ],
      },
