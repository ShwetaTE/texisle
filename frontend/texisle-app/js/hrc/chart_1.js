$(function () {
  ...
  futureDate1 = future_date_range(7);
  ...
  $.ajax(settings).done(function (response) {
    ...
    var data = response;
    // console.log("hrc", data);
    // console.log("week 1", data);
    Highcharts.chart("container2_2", {
      chart: {
        // spacingTop: 0,
        // width: 375,
        height: 280,
        ...
        breaks: [
          {
            ...
            to: data[1][data[1].length - 1][0] + 31 * 24 * 3600 * 1000, //days*hours*seconds*milliseconds
            breakSize: 0,
          },
        ],
      },
