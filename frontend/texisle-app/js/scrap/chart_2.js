$(function () {
  ...
  futureDate2 = future_date_range(30);

  var form = new FormData();
  form.append("chart", "Scrap");
        ...
        breaks: [
          {
            ...
            to: data[1][data[1].length - 1][0] + 61 * 24 * 3600 * 1000, //days*hours*seconds*milliseconds
            breakSize: 0,
          },
        ],
      },
