$(function () {
    ...
    form.append("chart", "Haynesville");

    var settings = {
        "url": urlresource + "/duc_data_1/",
        "method": "POST",
        "timeout": 0,
        "dataType": 'JSON',
        "processData": false,
    ...
    $.ajax(settings).done(function (response) {
        ...
        var data = response;
        Highcharts.chart('container_Haynesville_1', {
            chart: {
              // spacingTop: 0,
              // width: 375,
              height: 280,
        ...
        xAxis: {
          crosshair: {
            ...
            lang: {
              noData: "Data published on a monthly basis.<br> Please refer to the tabs having data<br> for 1 months or more to see the trends."
            },
          });
