$(document).ready(function () {
    ...
    function tweet_html_landing() {

        var settings = {
            // "url": urlresource + "/tweet_data_landing/",
            "url": urlresource + "/tweet_data_landing/",
            "method": "GET",
            "timeout": 0,
            "processData": false,
        ...
        $.ajax(settings).done(function (response) {
            ...
            if(res.length == 0){
                ...
                $.each(response.data, function (key, value) {
                    ...
                    // console.log(tweet_data_element);
    
                    $('#tweet_datatable').append(tweet_data_element);
                });
            }
        });
    }
